        ...
        <div className="relative">
            <div className="ml-[110px] bottom-0 left-0 p-2 border-l-4 border-yellow_default flex items-center">
                ...
                <div className="absolute right-[105px] top-0 flex h-[33px]">
                    ...
                    <button className={`focus:outline-none border-yellow_default text-md rounded-tr-md rounded-br-md border-2 font-semibold w-[100px] ${selectedCategory === "tvshow" ? "bg-yellow_default text-black" : "bg-black text-yellow_default"}`} onClick={() => handleCategoryChange("tvshow")}>
                        TV SHOW
                    </button>
                </div>
